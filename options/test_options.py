...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--temporary_path', type=str, default='./new_images',
                                 help='Temporary Path for latent calculation. BE REMOVED')
        ...
        self.parser.add_argument('--image_list', type=str, default=None,
                                 help='Name of blending images')
        self.parser.add_argument('--makeup_list', type=str, default=None,
                                 help='Name of makeup images')     
        self.parser.add_argument('--frontal_name', type=str, default=None,
                                 help='Name of blending images')        
